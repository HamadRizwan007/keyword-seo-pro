            ...
            <div class="col-md-4 mx-auto">
                <div class="row">
                    ...
                    <form action="#" method="post">
                        ...
                        <input type="submit" value="Login" class="login_btn_form width_available">
                        <div class="text_aft_btn_login">Don't have an account? <a href="sign_up.php"
                                class="signup_login_txt">Signup</span></a></div>
